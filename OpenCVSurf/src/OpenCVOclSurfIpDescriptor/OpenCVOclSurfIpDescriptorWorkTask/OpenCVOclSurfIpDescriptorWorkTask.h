...
class OpenCVOclSurfIpDescriptorWorkTask: public WorkTask {
public:
	OpenCVOclSurfIpDescriptorWorkTask();
	virtual ~OpenCVOclSurfIpDescriptorWorkTask();

	std::string getTaskName();
	static std::string returnTaskName();

	static WorkTask * Create() { return new OpenCVOclSurfIpDescriptorWorkTask(); };
