 ...
 */
#if 0
#ifndef OPENCVOCLSURFIPDESCRIPTOR_WORKCONSUMER_H
...
class OpenCVOclSurfIpDescriptorWorkConsumer: public WorkConsumer {
public:
	OpenCVOclSurfIpDescriptorWorkConsumer();
	virtual ~OpenCVOclSurfIpDescriptorWorkConsumer();
