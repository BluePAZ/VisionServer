...
#ifndef OPENCVGPUSURFDESCRIPTOR_WORKCONSUMER_H
#define OPENCVOCLSURFDESCRIPTOR_WORKCONSUMER_H
...
class OpenCVGpuSurfDescriptorWorkConsumer: public WorkConsumer {
public:
	OpenCVGpuSurfDescriptorWorkConsumer();
	virtual ~OpenCVGpuSurfDescriptorWorkConsumer();
