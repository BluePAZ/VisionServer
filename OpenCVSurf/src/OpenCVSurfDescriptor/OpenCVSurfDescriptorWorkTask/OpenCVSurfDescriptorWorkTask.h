...
#ifndef OPENCVSURFDESCRIPTOR_WORKTASK_H
#define OPENCVSURFDESCRIPTOR_WORKTASK_H
//#define _GLIBCXX_USE_CXX11_ABI 0

#include <WorkTask/WorkTask.h>
#include <SocketData/SocketData.hpp>

class OpenCVSurfDescriptorWorkTask: public WorkTask {
public:
	OpenCVSurfDescriptorWorkTask();
	virtual ~OpenCVSurfDescriptorWorkTask();

	std::string getTaskName();
	static std::string returnTaskName();

	static WorkTask * Create() { return new OpenCVSurfDescriptorWorkTask(); };
