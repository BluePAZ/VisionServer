...
#ifndef AKAZEDESCRIPTOR_WORKCONSUMER_H
#define AKAZEDESCRIPTOR_WORKCONSUMER_H
...
class AKAZEDescriptorWorkConsumer: public WorkConsumer {
public:
	AKAZEDescriptorWorkConsumer();
	virtual ~AKAZEDescriptorWorkConsumer();
