 ...
 */
#include "DataManagerWorkTask.h"

DataManagerWorkTask::DataManagerWorkTask(){
	// TODO Auto-generated constructor stub
}
DataManagerWorkTask::~DataManagerWorkTask(){
	// TODO Auto-generated constructor stub
}
void DataManagerWorkTask::init(){
	fprintf(stderr, "DataManagerWorkTask called init()\n");
	//TODO:: implement any startup logic
}
void DataManagerWorkTask::runTask(SocketData * data_in){
	fprintf(stderr, "DataManagerWorkTask called runTask()\n");
	...
	if(err != 0){
		fprintf(stderr, "DataManagerWorkTask, error creating thread\n");
	}
	pthread_detach(p);

}
void DataManagerWorkTask::runTaskThreadWork(struct WorkTaskThreadArgs * arg){
	//fprintf(stderr, "DataManagerWorkTask running\n");
	...
	arg->caller->dispatcher->submitWork("data_",aimData);
...
void DataManagerWorkTask::deInit(){
	//TODO: implement cleanup
	fprintf(stderr, "DataManagerWorkTask called deInit()\n");
}
void DataManagerWorkTask::parseParams(uint8_t * params){
	//TODO: implement any parameter parsing
}
<<<<<<< HEAD
uint8_t * DataManagerWorkTask::postProcess(uint8_t * rawResult, uint32_t * length){
...
std::string DataManagerWorkTask::returnTaskName(){
	return "aim_saliency";
}
std::string DataManagerWorkTask::getTaskName(){
	return "aim_saliency";
}
