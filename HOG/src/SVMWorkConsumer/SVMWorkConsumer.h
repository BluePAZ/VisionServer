...
#ifndef SVMWORKCONSUMER_SURFWORKCONSUMER_H_
#define SVMWORKCONSUMER_SURFWORKCONSUMER_H_
#ifdef __WIN32
//#include "stdafx.h"
	#include <vld.h>
	#include <thread>
...
class SVMWorkConsumer: public WorkConsumer {
public:
	SVMWorkConsumer();
	SVMWorkConsumer(IVortexNIFSAP * accel);

	virtual ~SVMWorkConsumer();

	static const int surfThreshold = 13107200;

	IVortexNIFSAP * AcceleratorInterface;
	VortexMemoryAllocation * HistogramHandle;
	VortexMemoryAllocation * SVMHandle;
	block_norm_v1_00_a * NCA;
