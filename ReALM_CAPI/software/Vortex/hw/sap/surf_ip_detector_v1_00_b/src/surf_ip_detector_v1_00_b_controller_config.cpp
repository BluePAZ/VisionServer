...
surf_ip_detector_v1_00_b_controller_config::surf_ip_detector_v1_00_b_controller_config(void)
{
...
uint16_t surf_ip_detector_v1_00_b_controller_config::GetWidth()
{
	return m_ControllerConfig.Width;
}

void surf_ip_detector_v1_00_b_controller_config::SetWidth(uint16_t value)
{
    m_ControllerConfig.Width = value;
}

uint16_t surf_ip_detector_v1_00_b_controller_config::GetHeight()
{
    return m_ControllerConfig.Height;
}

void surf_ip_detector_v1_00_b_controller_config::SetHeight(uint16_t value)
{
    m_ControllerConfig.Height = value;
}

IMAGE_DESCRIPTOR_TYPE surf_ip_detector_v1_00_b_controller_config::GetType()
{
	return (IMAGE_DESCRIPTOR_TYPE)m_ControllerConfig.Type;
}

void surf_ip_detector_v1_00_b_controller_config::SetType(IMAGE_DESCRIPTOR_TYPE value)
{
    m_ControllerConfig.Type = (uint8_t)value;
}

IMAGE_DESCRIPTOR_FORMAT_COLOR surf_ip_detector_v1_00_b_controller_config::GetFormatColor()
{
	return (IMAGE_DESCRIPTOR_FORMAT_COLOR)m_ControllerConfig.Color;
}

void surf_ip_detector_v1_00_b_controller_config::SetFormatColor(IMAGE_DESCRIPTOR_FORMAT_COLOR value)
{
    m_ControllerConfig.Color = (uint8_t)value;
}

IMAGE_DESCRIPTOR_FORMAT_DEPTH surf_ip_detector_v1_00_b_controller_config::GetFormatDepth()
{
	return (IMAGE_DESCRIPTOR_FORMAT_DEPTH)m_ControllerConfig.Depth;
}

void surf_ip_detector_v1_00_b_controller_config::SetFormatDepth(IMAGE_DESCRIPTOR_FORMAT_DEPTH value)
{
    m_ControllerConfig.Depth = (uint8_t)value;
}

void surf_ip_detector_v1_00_b_controller_config::SetBaseFlowID(uint16_t value)
{
    m_ControllerConfig.FlowID = value;
}

uint16_t surf_ip_detector_v1_00_b_controller_config::GetBaseFlowID()
{
    return m_ControllerConfig.FlowID;
}

uint16_t surf_ip_detector_v1_00_b_controller_config::GetPixelFetchFlowID()
{
	return m_ControllerConfig.FlowID;
}

uint16_t surf_ip_detector_v1_00_b_controller_config::GetResultStoreFlowID()
{
	return (m_ControllerConfig.FlowID == 0) ? 0 : m_ControllerConfig.FlowID + 2;
}

VortexDeviceAddress* surf_ip_detector_v1_00_b_controller_config::GetResultDeviceID()
{
	return m_ResultDeviceID;
}

void surf_ip_detector_v1_00_b_controller_config::SetResultDeviceID(uint8_t BusID, uint8_t SwitchID, uint8_t PortID)
{
	delete(m_ResultDeviceID);
...
uint64_t surf_ip_detector_v1_00_b_controller_config::GetResultAddress()
{
	return m_ControllerConfig.ResultAddress;
}

void surf_ip_detector_v1_00_b_controller_config::SetResultAddress(uint64_t value)
{
    m_ControllerConfig.ResultAddress = value;
}

VortexEntityType surf_ip_detector_v1_00_b_controller_config::GetConfigurationType()
{
	return VortexEntityType::SAP;
}

void surf_ip_detector_v1_00_b_controller_config::SetConfigurationType(VortexEntityType ConfigType)
{
}

uint64_t surf_ip_detector_v1_00_b_controller_config::GetIndex()
{
	return GetConfiguration()->GetAddress();
}

void surf_ip_detector_v1_00_b_controller_config::SetIndex(uint64_t Index)
{
	GetConfiguration()->SetAddress(Index);
}

uint16_t surf_ip_detector_v1_00_b_controller_config::GetNumChannels()
{
...
uint16_t surf_ip_detector_v1_00_b_controller_config::GetNumChannelsValid()
{
    switch(GetFormatColor())
	{
	case IMAGE_DESCRIPTOR_FORMAT_COLOR::NONE : return 1; break;
...
uint64_t surf_ip_detector_v1_00_b_controller_config::GetImageSizeBytes()
{
...
uint32_t surf_ip_detector_v1_00_b_controller_config::GetIPThreshold()
{
	return m_ControllerConfig.IPThreshold;
}

void surf_ip_detector_v1_00_b_controller_config::SetIPThreshold(uint32_t value)
{
	m_ControllerConfig.IPThreshold = value;
}

VortexConfigurationPacket* surf_ip_detector_v1_00_b_controller_config::GetConfiguration()
{
	m_Vcp->Clear();
