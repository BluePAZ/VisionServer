...
/// </summary>
vector<vector<vector<vector<int16_t>>>> aim_gabor_kernel::CreateGaborFilterBank(vector<int> Scales, int NumOrientations)
{
...
/// <returns></returns>
vector<vector<int16_t>> aim_gabor_kernel::CreateGaborFilter(double Angle, bool Odd, double Wavelength, double Sigma, int KernelSize, double Gamma)
{
