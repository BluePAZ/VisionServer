...
aim_configuration_list::aim_configuration_list(VortexDeviceAddress* DeviceID, uint64_t BaseAddress)
{
	m_DeviceID = DeviceID;
...
aim_configuration_list::~aim_configuration_list(void)
{
}

uint64_t aim_configuration_list::GetBaseAddress()
{
	return m_BaseAddress;
}

void aim_configuration_list::SetBaseAddress(uint64_t value)
{
	m_BaseAddress = value;
}

VortexDeviceAddress* aim_configuration_list::GetDeviceID()
{
	return m_DeviceID;
}

void aim_configuration_list::SetDeviceID(VortexDeviceAddress* value)
{
	m_DeviceID = value;
}

vector<VortexConfigurationGroup*> aim_configuration_list::GetConfigurationGroups()
{
...
void aim_configuration_list::Init()
{
...
void aim_configuration_list::Insert(IVortexConfiguration* Entry)
{
...
void aim_configuration_list::Insert(vector<IVortexConfiguration*> Entries)
{
