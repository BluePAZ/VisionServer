														  ...
														  uint32_t Threshold)
{
	...
	if (m_Simulation)
		...
		GetHistogramPageTableConfiguration()->SetGroupIDs(GetHistogramPageTableConfiguration()->CreateHOGHistogramPartition(MAXIMAGEWIDTH, MAXIMAGEHEIGHT, CELLSIZE, CELLSIZE));
