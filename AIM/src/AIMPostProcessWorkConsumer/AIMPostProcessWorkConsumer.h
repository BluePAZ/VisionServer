/*
 * AIMPostProcessWorkConsumer.h
 *
 *  Created on: Apr 6, 2016
 *      Author: root
 */

#ifndef SRC_AIMPOSTPROCESSWORKCONSUMER_AIMPOSTPROCESSWORKCONSUMER_H_
#define SRC_AIMPOSTPROCESSWORKCONSUMER_AIMPOSTPROCESSWORKCONSUMER_H_
...
class AIMPostProcessWorkConsumer: public WorkConsumer {
public:
	AIMPostProcessWorkConsumer();
	virtual ~AIMPostProcessWorkConsumer();
